...
export default function Topbar() {
  ...
  return (
    <header className="h-14 border-b border-[#21262d] bg-[#0d1117]/80 backdrop-blur-sm flex items-center justify-between px-5 sticky top-0 z-20">
      ...
      {!isOnline && <div className="flex items-center gap-1.5 text-yellow-400 text-xs bg-yellow-500/10 border border-yellow-500/20 px-2.5 py-1 rounded-full"><WifiOff size={12}/>Sin conexión</div>}
    </header>
  );
}
